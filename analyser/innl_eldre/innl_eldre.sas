...
%standard_rate(innl_eldre/SHO_liggetid, region= bohf, out=rate_liggetid, min_age=75);
...
%standard_rate(innl_eldre/innl_eldre, region= bohf, out=rate_opphold, min_age=75);
