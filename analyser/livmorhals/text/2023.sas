/*Livmorhals - biopsi/konisering */

/*Fjerning av livmortapp (konisering) og biopsi av livmorhalsen er en vanlig prosedyre for å undersøke celleforandringer i livmorhalsen.*/

/*Konisering LDC00 LDC03 */
/* Biopsi LDA10, LDA20 eller LDA96 + 212a */
...
Utvalget består av inngrep prosedyrekode LDA10, LDA20 eller LDA96 + LDC00 eller LDC03
på sykehus eller 
\n - med takstkode 212a + hos avtalespesialist + 210 for konisering
...
%let no_description =
Antall inngrep med biopsi av livmorhals pr 1 000 kvinner
;
